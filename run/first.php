...
?>
   ...
   <div id="aa" style="white-space:nowrap">
      ...
      <p id="cc" align="left">
      Find the best phone that suits your need!!
      </p>   
  ...
  <div class="usrnm">
      ...
      <label for="uname" class="userl"> <span class="usr-content">Username</span></label>
      </div>
      <br>
   <div class="pssd">
	...
	<div id="b"><input id="lg" type="submit" value="Login" /></div>
